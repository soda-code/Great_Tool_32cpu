...
static PARA _aPara[] = {
  ...
  { 2,  0, GUI_COUNTOF(_apText2_Single), 277,  90, _apText2_Single, NULL,            "RPM"},
...
static void _cbBk_BACKGROUND(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    if (hMemMessage == 0) {
      ...
      GUI_DispStringHCenterAt("Please note that this demo can not wash your clothes!", xSize / 2, ySize - 27);
      GUI_MEMDEV_Select(0);
    }
