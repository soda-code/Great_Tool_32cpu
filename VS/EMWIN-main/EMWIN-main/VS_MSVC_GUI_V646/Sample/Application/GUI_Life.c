...
*       _DoLife()
*/
static void _DoLife(GUI_ANIM_INFO * pInfo, void * pVoid) {
  GUI_USE_PARA(pInfo);
  GUI_USE_PARA(pVoid);
  //
  // Live!
...
void MainTask(void) {
  ...
  _InitializeSlide();
  //
  // Set up the animation to handle the speed of life independently of the CPU speed
  //
  hAnim = GUI_ANIM_Create(1000, 50, NULL, NULL);
  GUI_ANIM_AddItem(hAnim, 0, 1000, ANIM_LINEAR, NULL, _DoLife);
