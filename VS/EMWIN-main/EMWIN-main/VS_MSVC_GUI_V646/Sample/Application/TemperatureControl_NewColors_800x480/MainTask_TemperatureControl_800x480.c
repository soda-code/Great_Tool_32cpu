...
// Colors
//
#define DARK_BLUE   GUI_MAKE_COLOR(0x3C3C1E)
#define LIGHT_BLUE  GUI_MAKE_COLOR(0x686832)
#define BLUE        GUI_MAKE_COLOR(0x855a41)
#define LEMON       GUI_WHITE  //GUI_MAKE_COLOR(0x00d6d3)
...
//
static GUI_CONST_STORAGE GUI_FONT * pFont23pBold = &GUI_Font32B_AA4;
static GUI_CONST_STORAGE GUI_FONT * pFont32pBold = &GUI_Font32B_AA4;
static GUI_CONST_STORAGE GUI_FONT * pFont23p     = &GUI_Font32B_AA4;
