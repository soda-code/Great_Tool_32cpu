...
#define YPOS_FORECAST    150
#define YSIZE_FORECAST    60

#define XPOS_TEXT          5
#define YPOS_TEXT         40
#define XSIZE_TEXT       290
...
#define FONT_SYMBOL         &GUI_Font20_AA4
#define FONT_CITY           &GUI_Font32_AA4
#define FONT_DATE_AND_TIME  &GUI_Font20_AA4
#define FONT_TEMPERATURE    &GUI_Font60_AA4
...
static const struct CITY {
  ...
  int Temperature;
  int Weather;
  const unsigned aForeCast[NUM_DAYS];
  const unsigned aTemp    [NUM_DAYS];
} _aCity[] = {
  {
    "BERLIN",
    "15:20",
